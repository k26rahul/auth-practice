...
function renderTodos(todos) {
  console.log('todos are being rendered in ul...');
    ...
    todosUl.insertAdjacentHTML(
      ...
      html`
        <li class="${todo.isDone ? 'done' : ''}">
          <span onclick="markDone(${todo.id})">${todo.text}</span>
...
async function handleLogin(e) {
  ...
  console.log("hey it's handleLogin...");
...
function handleCreateTodo(e) {
  ...
  console.log("hey it's handleCreateTodo...");
}

async function fetchAllTodos() {
  console.log("hey it's fetchAllTodos...");
